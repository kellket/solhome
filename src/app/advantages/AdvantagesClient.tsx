    ...
    <>
      <section ref={sectionRef} className="relative overflow-hidden">
        <div ref={bgRef} className="absolute inset-0 w-full h-full">
          <img src="/bg18.webp" alt="Интерьер квартиры после капитального ремонта — Sol Home" className="w-full h-full object-cover object-center lg:hidden" />
          <img src="/bg17.webp" alt="Премиальный дизайнерский ремонт квартиры в Москве — Sol Home" className="w-full h-full object-cover object-center hidden lg:block" />
        </div>
